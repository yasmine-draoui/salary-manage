...
{{ request()->routeIs('employer.*') ? 'active' : '' }}"
                    ...
                    <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link"
                                    href="{{ route('employer.create') }}">Nouvel
                                    Employé</a>
                            </li>
                            <li class="submenu-item"><a class="submenu-link" href="{{ route('employer.index') }}">Liste
                                    des
                                    Employés</a>
                            </li>
                        </ul>
                ...
                <li class="nav-item has-submenu">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link submenu-toggle {{ request()->routeIs('departement.*') ? 'active' : '' }}"
                    ...
                    <div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link"
                                    href="{{ route('departement.create') }}">Nouveau département</a>
                            </li>
                            <li class="submenu-item"><a class="submenu-link"
                                    href="{{ route('departement.index') }}">Liste des
                                    départements</a>
                            </li>
                ...
                <li class="nav-item has-submenu">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link submenu-toggle {{ request()->routeIs('admin.*') ? 'active' : '' }}"
                    ...
                    <div id="submenu-3" class="collapse submenu submenu-3" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link"
                                    href="{{ route('admin.create') }}">Nouveau administrateur</a>
                            </li>
                            <li class="submenu-item"><a class="submenu-link" href="{{ route('admin.index') }}">Liste
                                    des
                                    administrateurs</a>
                            </li>
        ...
        <div class="app-sidepanel-footer">
            <nav class="app-nav app-nav-footer">
                <ul class="app-menu footer-menu list-unstyled">
                    <li class="nav-item">
                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                        <a class="nav-link {{ request()->routeIs('config.*') ? 'active' : '' }}"
