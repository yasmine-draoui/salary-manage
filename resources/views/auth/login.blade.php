	    ...
	    <div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
		    <div class="d-flex flex-column align-content-end">
			    <div class="app-auth-body mx-auto">
					...
					<h1 class="auth-heading text-center mb-4">Gestion de salaires</h1>

                    <h5 class="auth-heading text-center mb-4">Connectez vous</h5>
			        <div class="auth-form-container text-start">
						<form class="auth-form login-form" method="post" action="{{ route('handlelogin') }}">
							...
							<div class="email mb-3">
								...
								<input id="signin-email" name="email" type="email" class="form-control signin-email" placeholder="Adresse Email" required="required">
							</div><!--//form-group-->
							...
							<div class="text-center">
								<button type="submit" class="btn app-btn-primary w-100 theme-btn mx-auto">Connectez</button>
							</div>
						</form>
